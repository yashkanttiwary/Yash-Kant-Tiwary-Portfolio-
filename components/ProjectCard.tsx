...
import { Play, Pause, ArrowRight, Loader2, BookOpen, Image as ImageIcon } from 'lucide-react';
      ...
      <div className="mt-2">
        ...
        <div className="flex items-center gap-6">
          <button 
            ...
            className="inline-flex items-center text-sm font-bold text-white hover:text-accent-cyan transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-cyan rounded-sm px-1 -ml-1"
          ...
          {hasLiveLink ? (
            <a 
              ...
              className="inline-flex items-center text-sm font-bold text-gray-500 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-cyan rounded-sm px-1"
            >
              View Live <ArrowRight size={14} className="ml-1" />
            </a>
          ) : (
            <span className="inline-flex items-center text-sm font-bold text-gray-700 cursor-not-allowed opacity-60" title="Link coming soon">
              View Live <ArrowRight size={14} className="ml-1" />
            </span>
          )}
        </div>
